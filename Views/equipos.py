...
class Equipos(ctk.CTkFrame):
    ...
    def consultar_falla_equipo(self):
        ...
        consultar_falla_frame.grid(row=2, column=0, columnspan=5, pady=10)

    def agregar_equipo(self):
        self.clear_frame()
        agregar_equipo_frame = AgregarEquipo(self, self.db_manager)
        agregar_equipo_frame.grid(row=2, column=0, columnspan=5, pady=10)
    ...
    def relacionar_equipos(self):
        ...
        relacionar_equipos_frame.grid(row=2, column=0, columnspan=5, pady=10)
...
class ConsultarFallaEquipo(ctk.CTkFrame):
    def __init__(self, parent=None):
        ...
        # Título centrado
        self.title_label = ctk.CTkLabel(self, text="Consultar equipo",font=("Century Gothic", 20, "bold"),text_color="white")
        ...
        self.nro_bien_entry = ctk.CTkEntry(self, border_color="white", font=("Century Gothic", 14))
...
class AgregarEquipo(ctk.CTkFrame):
    def __init__(self, parent=None, db_manager=None):
        ...
        self.sede_dropdown = ctk.CTkComboBox(self, values=sede_names, command=self.on_sede_selected, state="readonly") 
