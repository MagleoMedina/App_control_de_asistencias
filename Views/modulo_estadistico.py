...
class ModuloEstadistico(ctk.CTkFrame):
    def __init__(self, parent=None):
        ...
        self.fecha_inicio_label = ctk.CTkLabel(self, text="Fecha de inicio", font=("Century Gothic", 13.5,"bold"))
        ...
        self.fecha_finalizacion_label = ctk.CTkLabel(self, text="Fecha de finalización",font=("Century Gothic", 13.5,"bold"))
